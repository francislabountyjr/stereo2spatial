...
def build_training_components(
    ...
    if is_legacy_vae_model(config):
        dataset: WaveformSongDataset | LatentSongDataset = LatentSongDataset(
            dataset_root=cast(Any, config.data.dataset_root),
            manifest_path=cast(Any, config.data.manifest_path),
